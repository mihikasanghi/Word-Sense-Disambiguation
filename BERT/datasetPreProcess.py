...
def getInfo(type, pos, lemma):
    ...
    for synset in set(wn.synsets(lemma, pos=word_pos)):
        key = None
...
xml_file = '../datasets/semcor.data.xml'
gold_txt_file = '../datasets/semcor.gold.key.txt'
output_file = '../datasets/semcor_bert_preprocessed.csv'
max_glossKey = 4
